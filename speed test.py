...
label=Label(root,text="Internet Speed Test",font=("Lucia Sans Unicode",20,"bold","italic"),fg="#5D6D7E",bg="#dee8f1")
label.place(relx=0.5,rely=0.1, anchor=CENTER)

label_download=Label(root,text="Download Speed ↓",font=("Segoe Print",18,"bold"),fg="#5D6D7E",bg="#dee8f1")
label_download.place(relx=0.25,rely=0.5, anchor=CENTER)

label_upload=Label(root,text="Upload Speed ↑",font=("Segoe Print",18,"bold"),fg="#5D6D7E",bg="#dee8f1")
...
btn_speed=Button(root, text="Check Speed",command=speedCheck, bg="#218796",fg="white", relief=FLAT)
